...
const ACTION_LABELS = {
  ...
  email_queue_retried:{ en: 'Email queue retried', es: 'Cola de correos reintentada' },
  email_queue_cleared:{ en: 'Email queue cleared', es: 'Cola de correos limpiada' },
  report_emailed:    { en: 'Report emailed',      es: 'Reporte enviado' },
